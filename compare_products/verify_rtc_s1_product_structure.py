...
FILENAME_CONVENTION_FIELDS = ('Project (== OPERA)',
                              'Level (== L2)',
                              'ProductShortName-Source (== RTC-S1)',
                              'BurstID',
                              'StartDateTime',
...
TABLE_4_1_PRODUCT_IDENTIFICATION_FIELDS = {
    ...
    'CONTACT_INFORMATION': 'uso@asf.alaska.edu',
    ...
    'STATIC_LAYERS_DATA_ACCESS': None,
    'BOUNDING_BOX': None,
    'BOUNDING_BOX_EPSG_CODE': None,
    'BOUNDING_BOX_PIXEL_COORDINATE_CONVENTION': None,
...
TABLE_4_2_INPUT_DATASETS_FIELDS = {
    'INPUT_L1_SLC_GRANULES': None,
    'INPUT_ORBIT_FILES': None,
    'INPUT_DEM_SOURCE': None,
    'INPUT_ANNOTATION_FILES': None,
...
TABLE_4_4_RTC_S1_PROCESSING_PARAMETERS = {
    ...
    'PROCESSING_INFORMATION_STATIC_TROPOSPHERIC_GEOLOCATION_CORRECTION_APPLIED': None,
...
TABLE_4_5_RTC_S1_RFI_INFORMATION = {
    'QA_GEOMETRIC_ACCURACY_BIAS_X': None,
    'QA_GEOMETRIC_ACCURACY_BIAS_Y': None,
    'QA_GEOMETRIC_ACCURACY_STDDEV_X': None,
    'QA_GEOMETRIC_ACCURACY_STDDEV_Y': None,
    #'IS_RFI_INFO_AVAILABLE': None,
    'QA_RFI_INFO_AVAILABLE': None,
    'QA_RFI_MITIGATION_PERFORMED*': None,
    'QA_RFI_MITIGATION_DOMAIN*': None,
    'QA_RFI_BURST_REPORT_SWATH*': None,
    'QA_RFI_BURST_REPORT_AZIMUTH_TIME*': None,
    'QA_RFI_IN_BAND_OUT_BAND_POWER_RATIO*': None,
    'QA_RFI_TIME_DOMAIN_REPORT_PERCENTAGE_AFFECTED_LINES*': None,
    'QA_RFI_TIME_DOMAIN_REPORT_AVG_PERCENTAGE_AFFECTED_SAMPLES*': None,
    'QA_RFI_TIME_DOMAIN_REPORT_MAX_PERCENTAGE_AFFECTED_SAMPLES*': None,
    'QA_RFI_FREQUENCY_DOMAIN_REPORT_NUM_SUB_BLOCKS*': None,
    'QA_RFI_FREQUENCY_DOMAIN_REPORT_SUB_BLOCK_SIZE*': None,
    'QA_RFI_FREQUENCY_DOMAIN_REPORT_ISOLATED_PERCENTAGE_AFFECTED_LINES*': None,
    'QA_RFI_FREQUENCY_DOMAIN_REPORT_ISOLATED_MAX_BANDWIDTH_PERCENTAGE_AFFECTED_LINES*': None,
    'QA_RFI_FREQUENCY_DOMAIN_REPORT_PERCENTAGE_BLOCKS_PERSISTENT_RFI*': None,
    'QA_RFI_FREQUENCY_DOMAIN_REPORT_MAX_PERCENTAGE_BW_AFFECTED_PERSISTENT_RFI*': None,
    #'QA_RFI_FREQUENCY_DOMAIN_BURST_REPORT_NUM_SUB_BLOCKS*': None,
    #'QA_RFI_FREQUENCY_DOMAIN_BURST_REPORT_SUB_BLOCKS_SIZE*': None,
    #'QA_RFI_FREQUENCY_DOMAIN_BURST_REPORT_ISOLATED_RFI_REPORT_PERCENTAGE_AFFECTED_LINES*': None,
    #'QA_RFI_FREQUENCY_DOMAIN_BURST_REPORT_PERCENTAGE_BLOCKS_PERSISTENT_RFI*': None,
    #'QA_RFI_FREQUENCY_DOMAIN_BURST_REPORT_MAX_PERCENTAGE_BW_AFFECTED_PERSISTENT_RFI*': None,
}
...
def compare_rtc_s1_metadata_structure(filepath):
    ...
    print_metadata_comparisons(TABLE_4_4_RTC_S1_PROCESSING_PARAMETERS, metadata)
...
def main():
    ...
    compare_rtc_s1_metadata_structure(file_1)
